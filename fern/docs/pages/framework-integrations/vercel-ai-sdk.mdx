...
The `@airweave/vercel-ai-sdk` package provides an `airweaveSearch` tool that integrates seamlessly with the [Vercel AI SDK](https://ai-sdk.dev). Search across all your synced data sources (Notion, Slack, Google Drive, databases, and 30+ more) in just a few lines of code.
