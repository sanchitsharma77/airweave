...
| shared_with_me_time | Optional[Any] | Time when this document was shared with the user. |
...
| created_time | Optional[Any] | When the document was created. |
| modified_time | Optional[Any] | When the document was last modified. |
| modified_by_me_time | Optional[Any] | Last time the user modified the document. |
| viewed_by_me_time | Optional[Any] | Last time the user viewed the document. |
