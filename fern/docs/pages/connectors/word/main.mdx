...
| created_datetime | Optional[datetime] | Timestamp at which the document was created. |
| last_modified_datetime | Optional[datetime] | Timestamp at which the document was last modified. |
