...
This connector enables AI agents and RAG systems to retrieve context from Sharepoint through Airweave's unified search layer.
...
|-------|------|-------------|
| id | str | SharePoint user ID. |
| display_name | str | The name displayed in the address book for the user. |
...
| web_url_override | Optional[str] | Link to the user's profile in SharePoint. |
...
| web_url_override | Optional[str] | Link to the group in Microsoft 365. |
...
| Field | Type | Description |
|-------|------|-------------|
| id | str | Site ID from Microsoft Graph. |
| display_name | str | The full title for the site. |
| site_name | Optional[str] | The name/title of the site. |
| description | Optional[str] | The descriptive text for the site. |
| web_url_override | Optional[str] | URL that displays the site in the browser. |
...
| web_url_override | Optional[str] | URL to view the drive in a browser. |
...
| name | str | Graph item name. |
| description | Optional[str] | User-visible description of the item. |
| web_url_override | Optional[str] | URL to display the item in a browser. |
...
|-------|------|-------------|
| id | str | List ID. |
| display_name | str | The displayable title of the list. |
| list_name | Optional[str] | The name of the list. |
| description | Optional[str] | The description of the list. |
| web_url_override | Optional[str] | URL to view the list in browser. |
...
|-------|------|-------------|
| id | str | List item ID. |
| title | str | Display title for the list item. |
...
| created_by | Optional[Dict[str, Any]] | Identity of the user who created the item. |
| last_modified_by | Optional[Dict[str, Any]] | Identity of the user who last modified the item. |
| web_url_override | Optional[str] | URL to view the item in browser. |
...
| page_name | Optional[str] | The name of the page. |
...
| web_url_override | Optional[str] | URL to view the page in browser. |
