...
| updated_time | Optional[datetime] | When the database was last edited. |
...
| updated_time | Optional[datetime] | When the page was last edited. |
...
| Field | Type | Description |
|-------|------|-------------|
| property_key | str | Stable unique identifier for the property entity. |
...
| Field | Type | Description |
|-------|------|-------------|
| file_id | str | ID of the file in Notion |
...
| web_url_value | Optional[str] | Link to view/download the file. |
