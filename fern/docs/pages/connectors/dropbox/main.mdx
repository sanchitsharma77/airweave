...
|-------|------|-------------|
| account_id | str | Dropbox account ID |
...
| client_modified | Optional[Any] | When file was modified by client |
| server_modified | Optional[Any] | When file was modified on server |
