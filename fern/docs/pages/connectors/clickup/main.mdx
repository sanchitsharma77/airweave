...
| name | str | Space name |
| workspace_id | str | Parent workspace ID |
...
| task_id | str | Task ID |
| name | str | Task name |
| created_at | Optional[Any] | Task creation timestamp |
| updated_at | Optional[Any] | Task update timestamp |
...
| due_date | Optional[Any] | Task due date |
| start_date | Optional[Any] | Task start date |
...
| created_at | Optional[Any] | When the comment was created |
...
| created_at | Optional[Any] | Subtask creation timestamp |
| updated_at | Optional[Any] | Subtask update timestamp |
...
| due_date | Optional[Any] | Subtask due date |
